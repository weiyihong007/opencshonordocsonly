...
??? note "LSTM & Transformer 代码包"
    <iframe 
        loading="lazy" 
        src="../../../../utils/xjtu-cshonor-utils/机器学习讨论班/后续内容/lstm transformer.zip"
        width="100%" 
        height="600px"
        style="border:none">
    </iframe> 
...
??? note "RNN, Transformer, GAN 演示文稿"
    <iframe 
        loading="lazy" 
        src="../../../../utils/xjtu-cshonor-utils/机器学习讨论班/后续内容/RNN, Transformer, GAN.pptx"
        width="100%" 
        height="600px"
        style="border:none">
    </iframe> 
...
- ??? note "SVD & PCA 学习资料"
    <iframe 
        loading="lazy" 
        src="../../../../utils/xjtu-cshonor-utils/机器学习讨论班/后续内容/SVD&PCA.zip"
        width="100%" 
        height="600px"
        style="border:none">
    </iframe> 
